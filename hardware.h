...
#define WIFI_USART_SPEED_DEFAULT		115200
...
#define RADIO_GPIO_USART_TX_PIN			GPIO_Pin_11
#define RADIO_GPIO_USART_RX_PIN			GPIO_Pin_10
#define RADIO_GPIO_VSYNC_PIN			GPIO_Pin_12
#define RADIO_GPIO_USART_TX_PINSOURCE	GPIO_PinSource11
#define RADIO_GPIO_USART_RX_PINSOURCE	GPIO_PinSource10
#define RADIO_GPIO_USART_AF				GPIO_AF_USART3
#define RADIO_GPIO_EXTI_PORTSOURCE		EXTI_PortSourceGPIOB
#define RADIO_GPIO_EXTI_VSYNC_PINSOURCE	EXTI_PinSource12
#define RADIO_GPIO_EXTI_VSYNC_LINE		EXTI_Line12
#define RADIO_GPIO_NVIC_CHANNEL			EXTI15_10_IRQn
#define RADIO_USART						USART3
#define RADIO_USART_CLOCK				RCC_APB1Periph_USART3
#define RADIO_USART_CLOCK_FUN			RCC_APB1PeriphClockCmd
#define RADIO_USART_SPEED				115200
#define RADIO_USART_NVIC_CHANNEL		USART3_IRQn
#define RADIO_USART_IRQHANDLER			USART3_IRQHandler
#define RADIO_DMA						DMA1
#define RADIO_DMA_CLOCK					RCC_AHB1Periph_DMA1
#define RADIO_DMA_TX_CHANNEL			DMA_Channel_4
#define RADIO_DMA_TX_STREAM				DMA1_Stream3
#define RADIO_DMA_TX_FLAG_TCIF			DMA_FLAG_TCIF3
#define RADIO_DMA_TX_NVIC_IRQn			DMA1_Stream3_IRQn
#define RADIO_DMA_TX_IRQHANDLER			DMA1_Stream3_IRQHandler
