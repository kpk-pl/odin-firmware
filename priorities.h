...
#define PRIORITY_ISR_RADIOUSART			6
#define PRIORITY_ISR_RADIODMATX			7
#define PRIORITY_ISR_COMDMARX			8
#define PRIORITY_ISR_WIFIDMARX			8
#define PRIORITY_ISR_RC5_TIM			9
#define PRIORITY_ISR_SWITCHES_TIM		9
#define PRIORITY_ISR_SWITCHES			10
#define PRIORITY_ISR_COMUSART			11
#define PRIORITY_ISR_WIFIUSART			11
